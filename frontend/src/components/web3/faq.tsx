                    ...
                    <form onSubmit={methods.handleSubmit(onSubmit)} className="flex flex-col gap-2">
                        <Button type="button" onClick={openModal}>
                            ...
                            {fields.map((field, index) => (
                                <div key={field.id} className={cn("w-full flex items-center justify-between")}>
...
const FaqFormModal: FC<{ onConfirm: (faq: FAQ) => void, editData?: FAQ }> = ({ onConfirm, editData }) => {
        ...
        <div className="modal-content-wrapper">
            <Card className="card-component">
                <CardContent className="pb-3 pt-6">
                    ...
                    <input {...register('question')} type="text" placeholder="Reward Tier Title" className={inputClassName} />
